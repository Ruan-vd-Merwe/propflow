...
function UnsubscribeContent() {
  ...
  const [status, setStatus] = useState<'pending' | 'unsubscribed' | 'error' | 'resubscribed'>('pending')
      ...
      <main className="mx-auto flex max-w-md flex-col items-center px-4 py-24 text-center">
        ...
        {status === 'unsubscribed' && (
          <>
            ...
            <h1 className="text-xl font-bold text-slate-900">You have been unsubscribed</h1>
            ...
            <Link href="/" className="mt-3 block text-sm text-slate-400 hover:text-slate-700">
              Back to PropTrust
            </Link>
          </>
        )}
        ...
        {status === 'resubscribed' && (
          <>
            ...
            <Link href="/" className="mt-6 block text-sm text-blue-600 hover:underline">
              Back to PropTrust
            </Link>
          </>
        )}
