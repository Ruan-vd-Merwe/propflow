...
import type { ReferenceCheck, BankStatementAnalysis, IdVerification } from '@/lib/types'
...
export async function PATCH(
  ...
  try {
    ...
    if ('reference_checks' in body) {
      ...
      const analysis   = existing.bank_statement_analysis as BankStatementAnalysis
      ...
      const income     = existing.monthly_income_cents ?? analysis?.avgMonthlyIncome ?? 0
