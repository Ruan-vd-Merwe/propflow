...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 antialiased">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-10 flex flex-col items-center gap-3">
            ...
            <div className="flex w-full max-w-sm gap-3 sm:w-auto">
              <Link
                href="/for-landlords"
                className="flex-1 rounded-full border-2 border-white/25 px-5 py-3.5 text-center text-sm font-bold text-white transition hover:border-white/50 hover:bg-white/5 active:scale-95 sm:flex-none sm:px-7"
              >
                List my property
              </Link>
              <Link
            ...
            <Link
              href="/become-a-connector"
              className="mt-1 text-sm font-medium text-emerald-300 transition hover:text-emerald-200 hover:underline"
            >
              Become a Connector &rarr;
            </Link>
          </div>
        </div>
      </section>
      ...
      {/* ── 7. CONNECTORS: PEOPLE HELPING PEOPLE ─────────────────────────── */}
      <section id="connectors" className="bg-white px-6 py-20 md:py-28">
        <div className="mx-auto max-w-6xl">
          <div className="mb-14 max-w-3xl">
            ...
            <h2 className="text-3xl font-extrabold tracking-tight text-[#0f172a] md:text-4xl">
              People helping people rent safely.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-slate-500">
              Some people need more than an online application. They need local
              knowledge, someone they trust, or simply a helping hand.
            </p>
            <p className="mt-4 text-sm leading-relaxed text-slate-500">
              Connectors are verified community members who assist tenants and
              landlords with practical tasks during the rental journey. They help
              people move, settle in, verify properties, conduct inspections, and
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              "Take photos and videos for someone moving to Cape Town",
              "Verify that a listing exists",
              "Help newcomers understand neighbourhoods",
              "Assist with key handovers",
              "Coordinate maintenance visits",
              "Support elderly landlords or students moving cities",
            ].map((task) => (
              <div
                key={task}
                className="flex items-start gap-3 rounded-xl bg-[#f8fafc] px-5 py-4"
              >
          ...
          <div className="mt-10">
            <Link
              href="/become-a-connector"
              className="inline-block rounded-full bg-emerald-700 px-7 py-3.5 text-sm font-bold text-white transition hover:bg-emerald-800"
            >
              Become a Connector
            </Link>
          </div>
      ...
      {/* ── 8. WHO CAN BECOME A CONNECTOR? ────────────────────────────────── */}
      <section className="bg-[#f8fafc] px-6 py-20 md:py-28">
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-extrabold tracking-tight text-[#0f172a] md:text-4xl">
              Who can become a Connector?
            </h2>
            <p className="mx-auto mt-5 max-w-2xl text-sm leading-relaxed text-slate-500">
              Anyone who enjoys helping people and wants to contribute to safer
              renting can become a Connector.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              {
                title: "Psychology and Social Science Graduates",
                desc: "Apply your understanding of people and communities to real-world rental support.",
              },
              {
                title: "Students",
                desc: "Help others in your area while building trust and experience.",
              },
              {
                title: "Retired Professionals",
                desc: "Share decades of local knowledge and practical skills.",
              },
              {
                title: "Community Volunteers",
                desc: "Extend the work you already do into rental support.",
              },
              {
                title: "Part-Time Workers",
                desc: "Help people on a schedule that fits your life.",
              },
              {
                title: "Local Area Experts",
                desc: "You know your neighbourhood — help newcomers feel at home.",
              },
            ].map((card) => (
              <div
                key={card.title}
              ...
              >
                <h3 className="mb-2 text-sm font-bold text-[#0f172a]">
                  {card.title}
                </h3>
                <p className="text-sm leading-relaxed text-slate-500">
                  {card.desc}
      ...
      {/* ── 9. BUILD TRUST BY HELPING OTHERS (sample profile) ─────────────── */}
      <section className="bg-white px-6 py-20 md:py-28">
        <div className="mx-auto max-w-6xl">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mb-5 text-3xl font-extrabold tracking-tight text-[#0f172a] md:text-4xl">
                Build trust by helping others.
              </h2>
              <p className="text-sm leading-relaxed text-slate-500">
                Every completed task, positive review, and verified interaction
                builds your Connector reputation. The more you help, the more
                visible and trusted you become in your community.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-[#f8fafc] p-6 lg:p-8">
              ...
              <div className="mt-5 flex items-center gap-1">
                {[1, 2, 3, 4, 5].map((s) => (
                  <svg
                    key={s}
                    className={`h-4 w-4 ${s <= 4 ? "text-amber-400" : "text-amber-300"}`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
              ...
              <div className="mt-4 flex flex-wrap gap-x-5 gap-y-1 text-xs text-slate-500">
                <span>74 people helped</span>
                <span>32 completed tasks</span>
                <span>96% reliability</span>
              </div>

              <div className="mt-3 flex flex-wrap gap-2">
                {["Sea Point", "Green Point", "Gardens"].map((area) => (
                  <span
                    key={area}
              ...
              <div className="mt-5 space-y-3">
                {[
                  "Sarah attended the viewing and sent a detailed video.",
                  "She made moving to Cape Town much less stressful.",
                ].map((review) => (
                  <div
                    key={review}
                    className="rounded-lg bg-white px-4 py-3 text-sm italic text-slate-600 shadow-sm"
                  >
                    &ldquo;{review}&rdquo;
                  </div>
                ))}
      ...
      {/* ── 10. COMMUNITY FIRST (gratitude model) ─────────────────────────── */}
      <section className="bg-[#f8fafc] px-6 py-20 md:py-28">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-base leading-relaxed text-slate-500">
            Most interactions are based on trust and helping others. People can
            choose to show appreciation by leaving a thank-you tip.
          </p>

          <div className="mt-10 flex flex-wrap justify-center gap-4">
            {[
              { label: "Buy me a coffee", icon: "☕" },
              { label: "Buy me lunch", icon: "🍞" },
              { label: "Leave a thank-you tip", icon: "🙏" },
            ].map((item) => (
              <div
                key={item.label}
                className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-white px-6 py-4 shadow-sm"
              >
          ...
          <p className="mt-6 text-xs text-slate-400">
            Appreciation is optional and always at the discretion of the person
            being helped. No transaction features are live yet.
          </p>
        </div>
      </section>

      {/* ── 11. VERIFIED TASKS & FEES (stubbed) ──────────────────────────── */}
      <section className="bg-white px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-extrabold tracking-tight text-[#0f172a] md:text-4xl">
              Verified tasks and transparent fees.
            </h2>
            <p className="mt-5 text-sm leading-relaxed text-slate-500">
              Some tasks may carry standardised, platform-set fees — transparent
              and the same for everyone. Connectors stay neutral and focused on
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              {
                task: "Property viewing assistance",
                fee: "Coming soon",
              },
              {
              ...
              {
                task: "Key handover coordination",
                fee: "Coming soon",
              },
            ].map((item) => (
              <div
                key={item.task}
                className="flex items-center justify-between rounded-xl border border-slate-200 bg-[#f8fafc] px-5 py-4"
              >
                <span className="text-sm font-medium text-slate-700">
                  {item.task}
                </span>
          ...
          <p className="mt-6 text-center text-xs text-slate-400">
            Indicative only. Fees are not yet active. All fees will be set by
            PropTrust, not by individual Connectors.
          </p>
        </div>
      </section>

      {/* ── 12. REPUTATION MATTERS (trust points display) ─────────────────── */}
      <section className="bg-[#f8fafc] px-6 py-20 md:py-28">
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-extrabold tracking-tight text-[#0f172a] md:text-4xl">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-sm leading-relaxed text-slate-500">
              Trust points are earned by completing tasks and receiving genuine
              reviews — never by deals closing or leases being signed.
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="space-y-3">
                {[
                  { pts: "+10", label: "Attend a viewing" },
                  { pts: "+20", label: "Positive review received" },
                  { pts: "+30", label: "Verified inspection completed" },
                  { pts: "+50", label: "Tenant successfully assisted" },
                ].map((row) => (
                  <div
                    key={row.label}
                    className="flex items-center gap-4 rounded-xl bg-white px-5 py-3.5 shadow-sm"
                  >
              ...
              <p className="mt-4 text-xs text-slate-400">
                &ldquo;Successfully assisted&rdquo; means the task was completed
                and reviewed — not that a lease was signed.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="mb-6 flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={badge}
                    className="rounded-full border border-emerald-200 bg-emerald-50 px-4 py-1.5 text-xs font-semibold text-emerald-800"
                  >
                    {badge}
                  </span>
                ))}
              ...
              <ul className="space-y-3">
                {[
                  "Higher visibility in your area",
                  "Access to verified tasks",
          ...
          <p className="mt-8 text-center text-xs text-slate-400">
            Trust points and badges are illustrative. The live reputation engine
            is not yet active.
          </p>
        </div>
      </section>

      {/* ── 13. RENTING WORKS BETTER ──────────────────────────────────────── */}
      <section className="bg-emerald-800 px-6 py-20 text-center md:py-24">
        <div className="mx-auto max-w-2xl">
          <h2 className="text-3xl font-extrabold text-white md:text-4xl">
            Renting works better when people help people.
          </h2>
          <p className="mt-5 text-base leading-relaxed text-emerald-100">
            PropTrust combines technology with trusted local communities, making
            renting safer, more human, and more accessible for everyone.
          </p>
          <div className="mt-8">
            <Link
              href="/become-a-connector"
              className="inline-block rounded-full bg-white px-7 py-3.5 text-sm font-bold text-emerald-800 transition hover:bg-emerald-50 active:scale-95"
            >
              Become a Connector
            </Link>
          </div>
        ...
        <div className="mx-auto max-w-xl">
          ...
          <div className="mt-10 flex flex-col items-center gap-3">
            ...
            <div className="flex w-full max-w-sm gap-3 sm:w-auto">
              <Link
                href="/for-landlords"
                className="flex-1 rounded-full border-2 border-white/40 px-5 py-3.5 text-center text-sm font-bold text-white transition hover:border-white hover:bg-white/10 active:scale-95 sm:flex-none sm:px-7"
              >
                List my property
              </Link>
              <Link
            ...
            <Link
              href="/become-a-connector"
              className="mt-1 text-sm font-medium text-emerald-200 transition hover:text-white hover:underline"
            >
              Become a Connector &rarr;
            </Link>
          </div>
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="flex flex-col rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
            ...
            <p className="mb-6 flex-1 text-sm leading-relaxed text-slate-500">
              Trusted local people help with viewings, check-ins, and real human
              support. Appreciation comes through reviews and optional tips.
            </p>
            <p className="mb-6 text-xs text-slate-400">
              Connectors are verified community members.
            </p>
            <Link
            ...
            <div className="mt-8 grid gap-6 text-left md:grid-cols-3">
              ...
              <div className="rounded-xl bg-[#f8fafc] p-6">
                ...
                <ul className="space-y-2.5 text-sm text-slate-600">
                  ...
                  <li className="flex items-start gap-2.5">
                    <span className="mt-0.5 text-slate-300">&middot;</span>
                    Some verified tasks may carry transparent, platform-set fees
                  </li>
                </ul>
