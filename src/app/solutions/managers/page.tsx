...
const STEPS = [
  {
    title: "Set up your management account",
    body: "Create a property management account and configure your team access settings.",
  },
  {
    title: "Add your portfolio",
    body: "Import properties and invite tenants. Existing tenants receive a portal link to get started.",
  },
  {
    title: "Manage with structure",
    body: "Track rent, screen new applicants, manage maintenance and keep landlord reporting organised.",
  },
];
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            ...
            <p className="mb-10 text-lg leading-relaxed text-slate-300">
              PropTrust gives property managers a structured platform for
              screening, rent tracking, maintenance and body corporate
              administration, across any portfolio size.
            </p>
            ...
            <p className="mt-4 text-xs text-slate-500">
              Professional plans from R299/month. 30-day free trial.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#1e40af] px-6 py-24 text-center">
        <div className="mx-auto max-w-xl">
          ...
          <p className="mb-10 text-blue-100">
            Professional plan from R299/month. No credit card required to start.
          </p>
