...
const BENEFITS = [
  ...
  },
  {
    ...
    perks: ['Payment history tracking', 'References over time', 'Portable rental record'],
  },
  {
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 antialiased">
      ...
      <section className="bg-[#0f172a] px-6 pb-20 pt-20 md:pt-28">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            <p className="mb-4 text-xs font-bold uppercase tracking-widest text-green-400">For Tenants</p>
            ...
            <p className="mt-4 text-xs text-slate-500">Free for tenants. Always.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#f8fafc] px-6 py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mb-4 text-2xl font-extrabold text-[#0f172a]">Your data, your control</h2>
          <p className="mb-6 text-base leading-relaxed text-slate-500">
            PropTrust is POPIA compliant. Your personal details are stored securely and are only shared with landlords when you actively choose to connect with them. You can update or remove your information at any time.
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            {['POPIA Compliant', 'Encrypted storage', 'You control sharing', 'Delete anytime'].map(label => (
              <span key={label} className="rounded-full border border-green-200 bg-green-50 px-3.5 py-1.5 text-sm font-medium text-green-700">
                {label}
              </span>
            ))}
          </div>
      ...
      <section className="bg-[#1e40af] px-6 py-24 text-center">
        <div className="mx-auto max-w-xl">
          <h2 className="mb-5 text-3xl font-extrabold text-white">Create your free tenant profile</h2>
          <p className="mb-10 text-blue-100">Free for tenants. Always. Takes a few minutes to set up.</p>
