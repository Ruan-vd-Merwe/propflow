...
const STEPS = [
  {
    ...
    body: "Sign up and set up your landlord profile. It takes a few minutes and no credit card is required.",
  },
  {
    title: "Add your property",
    body: "Capture property details, rental amount and lease information. Invite existing tenants or wait for new applications.",
  },
  {
    title: "Manage tenants with confidence",
    body: "Screen applicants, track rent, handle maintenance requests and keep documents organised, all from one dashboard.",
  },
];
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 antialiased">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            ...
            <p className="mb-10 text-lg leading-relaxed text-slate-300">
              PropTrust gives you the tools to screen tenants, track rent,
              manage maintenance and keep documents organised, without handing
              control to an agent.
            </p>
      ...
      <section className="bg-[#f8fafc] px-6 py-20">
        <div className="mx-auto max-w-5xl text-center">
          <h2 className="mb-10 text-2xl font-extrabold text-[#0f172a]">
            Features designed for landlords
          </h2>
        ...
        <div className="mx-auto max-w-3xl rounded-3xl border border-[#e2e8f0] bg-[#f8fafc] p-10 text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-8 sm:flex-row">
            {[
              ...
              <div
                key={p.name}
                className={`flex-1 rounded-2xl p-6 ${p.featured ? "bg-[#0f172a] text-white" : "bg-white border border-[#e2e8f0]"}`}
              >
                <p
