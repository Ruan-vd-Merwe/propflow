    ...
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:shadow-md">
      ...
      {expanded && (
        <div className="border-t border-slate-100 bg-slate-50 px-5 py-4 text-xs text-slate-600">
          ...
          {[
            { label: "Yield", insight: ins.yield, note: null },
            { label: "Capital growth", insight: ins.capital_growth, note: null },
            { label: "Stability", insight: ins.stability, note: null },
            { label: "Value", insight: ins.value, note: null },
            {
              label: "Liquidity",
              insight: ins.liquidity,
              note: "Limited data — uses estimated defaults for days-to-sell and sales volume.",
            },
            {
              label: "Risk",
              insight: ins.risk,
              note: "Crime index is per-suburb; levy, maintenance and supply pipeline use estimated defaults.",
            },
          ].map(({ label, insight, note }) =>
            insight ? (
...
export default function InvestmentScoresPage() {
      ...
      <section className="bg-[#0f172a] px-6 pb-14 pt-14">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-slate-400">
            Compare suburbs across rental yield, growth potential, stability,
            demand and risk — so you can identify stronger property investment
            areas.
          </p>
          <p className="mt-2 text-xs text-slate-500">
            Scores are indicative estimates based on available market data. Not
            financial advice.
          </p>
        </div>
      </section>
      ...
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        ...
        <div className="mb-10 rounded-2xl border border-slate-200 bg-white p-7">
          ...
          <p className="mb-5 text-sm leading-relaxed text-slate-500">
            Investment Scores help you compare suburbs based on estimated rental
            yield, growth potential, market stability, rental demand and risk
            signals. These scores are designed for property research and should
            not be treated as financial advice.
          </p>
          <div className="mb-5 grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
            {[
              "Estimated gross rental yield",
              "Annual capital growth trends",
              "Vacancy rates and rental stability",
              "Risk signals including crime index",
              "Relative value compared to area averages",
              "Market liquidity indicators (limited data)",
            ].map((item) => (
          ...
          <p className="text-xs text-slate-400">
            Data is a mix of curated market signals and available property
            information. Coverage varies by suburb. Some metrics use estimated
            defaults where suburb-specific data is limited.
          </p>
        </div>
