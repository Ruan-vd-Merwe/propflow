...
export default function LeasePage() {
  ...
  const portalLink = tt
    ? `${window.location.origin}/tenant/${tt.portal_token}`
    : "";
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-4xl px-6 py-8">
        ...
        <div
          id="lease-document"
          className="card overflow-hidden bg-white px-8 py-10 print:shadow-none"
        >
          {/* Header */}
          ...
          <section className="mb-8">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <DetailRow
                label="Contact"
                value={
                  [ll?.email, ll?.phone].filter(Boolean).join(" | ") || "—"
                }
              />
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <DetailRow
                label="Contact"
                value={
                  [tt?.email, tt?.phone].filter(Boolean).join(" | ") || "—"
                }
              />
            </div>
          </section>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <DetailRow
                ...
                value={
                  [
                    pp?.property_type,
                    pp?.bedrooms ? `${pp.bedrooms} bed` : null,
                  ]
                    .filter(Boolean)
                    .join(", ") || "—"
                }
          ...
          <section className="mb-8">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <DetailRow
                ...
                value={fmtDate(lease.lease_start)}
              />
              <DetailRow
                label="Termination date"
                value={
                  lease.lease_end ? fmtDate(lease.lease_end) : "Month-to-month"
                }
              />
              <DetailRow
                label="Monthly rental"
                value={fmtRand(lease.monthly_rent)}
              />
              <DetailRow
                label="Deposit"
                value={
              ...
              <DetailRow
                label="Payment due"
                value={`${ordinal(lease.payment_due_day)} of each month`}
              />
              <DetailRow
                label="Notice period"
              ...
              <DetailRow
                ...
                value={lease.pet_allowed ? "Yes" : "No"}
              />
              <DetailRow
                label="Subletting permitted"
                value={lease.subletting_allowed ? "Yes" : "No"}
              />
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <ol className="space-y-2 text-sm leading-relaxed text-slate-700">
              <li>
                <span className="font-semibold">1.</span> The tenant shall pay
                rent on or before the due date each month.
              </li>
              <li>
                <span className="font-semibold">2.</span> The tenant shall
                maintain the property in good and clean condition.
              </li>
              <li>
                <span className="font-semibold">3.</span> The tenant shall not
                make alterations without written consent from the landlord.
              </li>
              <li>
                <span className="font-semibold">4.</span> The tenant shall not
                sublet without written consent from the landlord.
              </li>
              <li>
                <span className="font-semibold">5.</span> The tenant shall
                comply with all body corporate rules where applicable.
              </li>
              <li>
                <span className="font-semibold">6.</span> The tenant shall give{" "}
                {lease.notice_period_days} days written notice of intention to
                vacate.
              </li>
            </ol>
          </section>
          ...
          <section className="mb-8">
            ...
            <ol className="space-y-2 text-sm leading-relaxed text-slate-700">
              <li>
                <span className="font-semibold">1.</span> The landlord shall
                maintain the property in a habitable condition.
              </li>
              <li>
                <span className="font-semibold">2.</span> The landlord shall not
                enter the property without reasonable notice except in
                emergency.
              </li>
              <li>
                <span className="font-semibold">3.</span> The landlord shall
                return the deposit within 21 days of vacating subject to
                inspection.
              </li>
            </ol>
          </section>
