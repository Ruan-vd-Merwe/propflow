...
export function StatusBar({
  ...
  return (
    <div
      className={`mb-8 flex flex-wrap items-center justify-between gap-3 rounded-xl border p-4 ${cls}`}
    >
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <p className="text-lg font-bold">
              This lease is protected by Xpello
            </p>
            {enrolledDate && (
              <p className="mt-1 text-sm text-emerald-200">
                Enrolled {fmtDate(enrolledDate)}
              </p>
            )}
            <a
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="mt-1.5 text-sm leading-relaxed text-slate-300">
            Evictions in South Africa can cost landlords over R40,000 in legal
            fees and lost rent. Xpello manages the full eviction process for you
          ...
          <p className="mt-4 text-xs text-slate-500">
            PropTrust refers landlords to Xpello as a recommended legal partner.
            This is a referral only — PropTrust is not a legal services
            provider.
          </p>
        </div>
      </div>
