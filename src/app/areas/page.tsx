...
const SUBURBS: SuburbData[] = [
  {
    ...
    vacancy: 0.06,
    crime_index: 45,
    description: 'Vibrant beachfront suburb with high demand and premium rentals.',
  },
  {
    name: 'Rondebosch',
    city: 'Cape Town',
    ...
    vacancy: 0.05,
    crime_index: 30,
    description: 'Established leafy suburb near UCT with consistent tenant demand.',
  },
  {
    name: 'Claremont',
    city: 'Cape Town',
  ...
  },
  {
    ...
    vacancy: 0.10,
    crime_index: 55,
    description: 'Financial hub with premium corporate tenants and high yields.',
  },
  {
    name: 'Fourways',
    city: 'Johannesburg',
    ...
    vacancy: 0.09,
    crime_index: 50,
    description: 'Family-friendly northern suburbs with growing infrastructure.',
  },
  {
    name: 'Menlyn',
    city: 'Pretoria',
    ...
    vacancy: 0.07,
    crime_index: 40,
    description: 'Eastern Pretoria retail and residential hub with steady growth.',
  },
  {
    name: 'Umhlanga',
    city: 'Durban',
  ...
  },
  {
    ...
    vacancy: 0.05,
    crime_index: 28,
    description: 'University town with strong student and young professional demand.',
  },
  {
    name: 'Greenpoint',
    city: 'Cape Town',
    ...
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:shadow-md">
      <div className="p-5">
        ...
        <div className="mt-4 flex items-center justify-between">
          <span className={`rounded-full px-2.5 py-1 text-xs font-semibold ${risk.cls}`}>
            {risk.label}
          </span>
          <button
      ...
      <section className="bg-[#0f172a] px-6 pb-14 pt-14">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-slate-400">
            PropTrust&apos;s scoring engine rates each suburb across yield, growth, stability and
            risk — so you can compare at a glance.
          </p>
      ...
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        ...
        <div className="mt-12 rounded-2xl bg-[#0f172a] px-8 py-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-lg text-slate-400">
            PropTrust helps landlords and investors manage properties, screen tenants
            and track performance from one platform.
          </p>
