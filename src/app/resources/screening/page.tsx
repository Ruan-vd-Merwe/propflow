...
const RED_FLAGS = [
  {
    flag: "Refuses to submit bank statements",
    why: "May indicate financial difficulty or reluctance to be transparent.",
  },
  {
    flag: "Income does not match stated employment",
    why: "Could indicate unreliable self-employment income or misrepresentation.",
  },
  {
    flag: "Multiple large irregular deposits",
    why: "May indicate income instability or undeclared income sources.",
  },
  {
    flag: "Account regularly in overdraft",
    why: "Suggests limited financial buffer and potential payment risk.",
  },
  {
    flag: "ID number does not match date of birth",
    why: "Could indicate an invalid or falsified ID document.",
  },
  {
    flag: "Cannot provide previous landlord contact",
    why: "Makes reference verification impossible; may suggest a difficult tenancy history.",
  },
  {
    flag: "Urgency to move in immediately with no context",
    why: "May indicate they have been evicted or are in a problematic housing situation.",
  },
  {
    flag: "Pressure to skip any part of the screening process",
    why: "Legitimate applicants generally welcome a structured process.",
  },
];
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            ...
            <p className="text-lg leading-relaxed text-slate-300">
              A practical, step-by-step guide to reviewing tenant applications
              before you sign a lease, written for South African landlords
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mb-5 text-base leading-relaxed text-slate-500">
                A single problematic tenancy can result in months of unpaid
                rent, property damage and a difficult eviction process. South
                African eviction law is tenant-protective, which means the cost
                of placing the wrong tenant can be significant, both financially
                and in time.
              </p>
              <p className="text-base leading-relaxed text-slate-500">
                A structured screening process does not eliminate risk entirely,
                but it significantly reduces it. It also gives you a documented
                basis for your decisions, which matters if a dispute arises
                later.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                {
                  label: "Average eviction timeline in SA",
                  value: "3–6 months",
                },
                {
                  label: "Court and legal costs (typical)",
                  value: "R8,000–R25,000+",
                },
                {
                  label: "Lost rent during dispute",
                  value: "R10,000–R50,000+",
                },
                {
                  label: "Screening time with PropTrust",
                  value: "Under 30 min",
                },
              ].map((s) => (
                <div
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="space-y-8">
            {STEPS.map((step, i) => (
              <div
                key={i}
                className="grid gap-6 rounded-2xl border border-[#e2e8f0] bg-white p-8 md:grid-cols-[auto_1fr]"
              >
                ...
                <div>
                  <h3 className="mb-3 text-lg font-extrabold text-[#0f172a]">
                    {step.title}
                  </h3>
      ...
      <section className="bg-white px-6 py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mb-12 max-w-xl text-base text-slate-500">
            None of these are automatic disqualifiers, context always matters.
            But each is worth investigating further before making a decision.
          </p>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {RED_FLAGS.map((r) => (
              <div
                key={r.flag}
                className="flex items-start gap-4 rounded-xl border border-amber-100 bg-amber-50 p-5"
              >
                <Warning />
                <div>
      ...
      <section className="bg-[#f8fafc] px-6 py-20">
        <div className="mx-auto max-w-4xl rounded-3xl bg-[#0f172a] p-10 text-white md:p-14">
          ...
          <h2 className="mb-4 text-2xl font-extrabold">
            How PropTrust handles screening
          </h2>
          <p className="mb-6 text-base leading-relaxed text-slate-300">
            PropTrust guides tenants through a structured submission process.
            They upload their ID, bank statements and references through their
            portal. You receive a clear summary, with ID validation, bank
            statement analysis and income assessment, so you can review the
            application without chasing documents manually.
          </p>
            ...
            {[
              {
                ...
                desc: "Know the legal framework before you sign a lease.",
              },
              {
                label: "FAQ",
                href: "/resources/faq",
                desc: "Common questions about the platform and the process.",
              },
              {
                label: "Tenant Screening",
                href: "/features#screening",
                desc: "How PropTrust's screening feature works.",
              },
            ].map((r) => (
              <Link
                key={r.label}
      ...
      <section className="bg-[#1e40af] px-6 py-24 text-center">
        <div className="mx-auto max-w-xl">
          <h2 className="mb-5 text-3xl font-extrabold text-white">
            Screen tenants with PropTrust
          </h2>
          <p className="mb-10 text-blue-100">
            Structured applications, ID validation and bank statement review,
            all in one place.
          </p>
