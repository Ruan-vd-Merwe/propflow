    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 antialiased">
      ...
      <section className="bg-[#0f172a] px-6 pb-20 pt-20 text-center md:pt-28">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="text-lg text-slate-300">
            Answers to common questions about PropTrust, accounts, pricing and how the platform works.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-3xl space-y-16">
          {SECTIONS.map(section => (
            <div key={section.title}>
              <h2 className="mb-6 text-xl font-extrabold text-[#0f172a]">{section.title}</h2>
      ...
      <section className="bg-white px-6 py-20">
        <div className="mx-auto max-w-2xl rounded-2xl border border-[#e2e8f0] bg-[#f8fafc] p-10 text-center">
          <h2 className="mb-3 text-2xl font-extrabold text-[#0f172a]">Still have a question?</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="mailto:hello@proptrust.co.za"
