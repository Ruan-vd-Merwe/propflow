      ...
      <main className="mx-auto max-w-3xl px-6 py-8">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Upload a PDF or paste the text of body corporate meeting minutes.
            Claude AI will extract and flag special levies, maintenance issues,
            legal disputes, and action items.
          </p>
        </div>
