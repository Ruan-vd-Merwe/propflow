    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 antialiased">
      ...
      <section className="bg-[#0f172a] px-6 pb-20 pt-20 text-center md:pt-28">
        <div className="mx-auto max-w-2xl">
          <p className="mb-4 text-xs font-bold uppercase tracking-widest text-blue-400">Contact</p>
          <h1 className="mb-5 text-5xl font-extrabold leading-tight tracking-tight text-white md:text-6xl">
            Get in touch
          </h1>
          <p className="text-lg text-slate-300">
            Questions about PropTrust, pricing or partnerships? We&apos;re happy to help.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#f8fafc] px-6 py-24">
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-12 lg:grid-cols-[5fr_7fr]">
            ...
            <div>
              <h2 className="mb-8 text-2xl font-extrabold text-[#0f172a]">Contact details</h2>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-sm text-slate-500">hello@proptrust.co.za</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-sm text-slate-500">Cape Town, South Africa</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-sm text-slate-500">Monday to Friday</p>
              ...
              <div className="mt-10 rounded-2xl border border-[#e2e8f0] bg-white p-6">
                <p className="text-sm font-bold text-[#0f172a]">Quick answers</p>
                <p className="mt-2 text-sm text-slate-500">
                  For pricing questions, see the{' '}
                  <a href="/pricing" className="text-[#1e40af] underline-offset-2 hover:underline">pricing page</a>.
                  For common questions, check the{' '}
                  <a href="/resources/faq" className="text-[#1e40af] underline-offset-2 hover:underline">FAQ</a>.
                </p>
              </div>
            </div>
