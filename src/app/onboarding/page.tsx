    ...
    <div className="mb-8 flex items-start justify-center gap-0">
      {steps.map((s, i) => (
        <div key={i} className="flex items-center">
          {i > 0 && (
            <div
              className={`mx-1 mt-4 h-0.5 w-10 shrink-0 sm:w-16 ${s.done || (i === 1 && step !== "property") ? "bg-slate-900" : "bg-slate-200"}`}
            />
          )}
...
export default function OnboardingPage() {
  ...
  async function handleTenantsSubmit() {
    ...
    const validRows = tenantRows.filter(
      (r) =>
        r.full_name.trim() && r.email.trim() && r.lease_start && r.monthly_rent,
    );
            ...
            {isWelcome ? (
              <>
                <h1 className="text-2xl font-bold text-slate-900">
                  Welcome to PropTrust!
                </h1>
                <p className="mt-2 text-slate-500">
                  Account created. Now let&apos;s add your first property.
                </p>
              </>
            ) : (
              <>
          ...
          <div className="card p-6">
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  className="input-field"
                  placeholder="12 Kloof Street, Gardens, Cape Town, 8001"
                  value={address}
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-slate-700">
                  Photos{" "}
                  <span className="text-slate-400">(up to 6, optional)</span>
                </label>
              ...
              <div className="flex items-start gap-3 rounded-xl border border-slate-200 p-4">
                ...
                <label htmlFor="is_listed">
                  <p className="text-sm font-medium text-slate-900">
                    List on tenant marketplace
                  </p>
                  <p className="mt-0.5 text-xs text-slate-500">
                    Allow matched tenants to see this property and request
                    introductions
                  </p>
                </label>
              </div>
      ...
      <div className="min-h-screen bg-slate-50 px-4 py-12">
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-slate-500">
              Do you already have tenants in this property? Add them now to
          ...
          {!addTenants ? (
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              >
                ...
                <div>
                  <p className="font-semibold text-slate-900">
                    Yes, add existing tenants
                  </p>
                  <p className="mt-1 text-sm text-slate-500">
                    Import your current tenants and payment history
                  </p>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    You can add tenants from the dashboard later
                  </p>
                </div>
              </button>
            </div>
            ...
            <div className="card p-6">
              ...
              <p className="mb-5 text-sm text-slate-500">
                Fill in details for each current tenant
              </p>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setTenantRows((prev) =>
                              prev.map((r, idx) =>
                                idx === i ? { ...r, phone: e.target.value } : r,
                              ),
                            )
                          }
                        />
              ...
              {tenantRows.length < 10 && (
                <button
                  type="button"
                  onClick={() =>
                    setTenantRows((prev) => [...prev, emptyTenant()])
                  }
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md text-center">
        ...
        <p className="mt-3 text-slate-500">
          Your property and tenants have been added. Taking you to the
          dashboard…
        </p>
        <button
          onClick={() => router.push("/dashboard")}
