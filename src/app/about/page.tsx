    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 antialiased">
      ...
      <section className="bg-[#0f172a] px-6 pb-24 pt-20 md:pt-28">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <p className="mb-4 text-xs font-bold uppercase tracking-widest text-blue-400">About PropTrust</p>
            <h1 className="mb-6 text-5xl font-extrabold leading-[1.1] tracking-tight text-white md:text-6xl">
              We are building a better way<br />
              <span className="text-[#3b82f6]">to manage South African rentals</span>
            </h1>
            <p className="text-lg leading-relaxed text-slate-300">
              PropTrust started with a straightforward frustration: the South African rental market is more complicated and more expensive than it needs to be. We are building the tools to change that.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white px-6 py-24">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            <div>
              <p className="mb-4 text-xs font-bold uppercase tracking-widest text-[#1e40af]">Our mission</p>
      ...
      <section className="bg-[#f8fafc] px-6 py-24">
        <div className="mx-auto max-w-4xl">
          <p className="mb-4 text-xs font-bold uppercase tracking-widest text-[#1e40af]">How we got here</p>
      ...
      <section className="bg-white px-6 py-24">
        <div className="mx-auto max-w-7xl">
          <p className="mb-4 text-xs font-bold uppercase tracking-widest text-[#1e40af]">What we believe</p>
          <h2 className="mb-14 text-3xl font-extrabold tracking-tight text-[#0f172a] md:text-4xl">
        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-6 rounded-3xl border border-[#e2e8f0] bg-white p-10 md:grid-cols-3">
            <div className="md:col-span-2">
              <h2 className="mb-3 text-2xl font-extrabold text-[#0f172a]">Get in touch</h2>
              <p className="text-sm leading-relaxed text-slate-500">
                We are a small team and we read every message. If you have a question about PropTrust, want to give feedback or are interested in working with us, reach out.
              </p>
              <p className="mt-4 text-sm font-semibold text-[#0f172a]">hello@proptrust.co.za</p>
              <p className="text-sm text-slate-400">Cape Town, South Africa · Mon–Fri 8am–5pm SAST</p>
            </div>
      ...
      <section className="bg-[#1e40af] px-6 py-24 text-center">
        <div className="mx-auto max-w-xl">
          <h2 className="mb-5 text-3xl font-extrabold text-white">Try PropTrust for free</h2>
