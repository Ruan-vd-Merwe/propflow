            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateCheck(check.id, "landlordName", e.target.value)
                  }
              ...
              <div>
                ...
                <input
                  ...
                  value={check.contact}
                  onChange={(e) =>
                    updateCheck(check.id, "contact", e.target.value)
                  }
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateCheck(
                      check.id,
                      "response",
                      e.target.value as ReferenceResponse,
                    )
                  }
                ...
                {check.contacted && (
                  <span
                    className={`text-sm font-semibold ${
                      RESPONSES.find((r) => r.value === check.response)
                        ?.colour ?? ""
                    }`}
                  >
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setDraft((d) => ({ ...d, landlordName: e.target.value }))
                }
                placeholder="John Smith"
              />
            </div>
  ...
  const opts: { value: string; label: string; colour: string }[] = [
    {
      value: "pending",
      label: "Pending",
      colour: "border-amber-400 bg-amber-50 text-amber-700",
    },
    {
      value: "approved",
      label: "Approve",
      colour: "border-emerald-400 bg-emerald-50 text-emerald-700",
    },
    {
      value: "rejected",
      label: "Reject",
